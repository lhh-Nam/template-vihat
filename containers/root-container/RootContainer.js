...
import { webLocalPath, webLocalRedirect } from '../../constants/Domain';
...
class RootContainer extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        if (host === webLocalPath || (host.indexOf(webLocalPath) > -1 && `http://${host}` !== webLocalRedirect)) {
            window.location.href = webLocalRedirect;
        } else {
            setDomainWeb(host);
